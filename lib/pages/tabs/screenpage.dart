...
class _ScreenPageState extends State<ScreenPage> {
          ...
          children: [
            ...
            OutlinedButton(
              ...
              onPressed: () {
                ...
                _navigateToAnalysisPage(_image!); // 跳轉到分析頁面
              },
              child: const Text(
                '送出診斷',
                style: TextStyle(
  ...
  // 跳轉到分析頁面
  void _navigateToAnalysisPage(File image) {
    Navigator.push(
      context,
      MaterialPageRoute(
        // builder: (context) => WoundAnalysisPage(image: image), // 傳遞圖片
        builder: (context) => ResultPage(image: image), // 傳遞圖片
      ),
    );
                      ...
                      children: [
                        Container(
                          ...
                          child: IconButton(
                            ...
                            icon: const Icon(MyFlutterApp.picture),
                            iconSize: 30,
